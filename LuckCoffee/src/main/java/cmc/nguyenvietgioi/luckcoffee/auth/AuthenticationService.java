package cmc.nguyenvietgioi.luckcoffee.auth;

import cmc.nguyenvietgioi.luckcoffee.config.JwtService;
import cmc.nguyenvietgioi.luckcoffee.config.SecurityUtils;
import cmc.nguyenvietgioi.luckcoffee.domain.Role;
import cmc.nguyenvietgioi.luckcoffee.domain.User;
import cmc.nguyenvietgioi.luckcoffee.dto.UserDto;
import cmc.nguyenvietgioi.luckcoffee.repository.UserRepository;
import cmc.nguyenvietgioi.luckcoffee.token.Token;
import cmc.nguyenvietgioi.luckcoffee.token.TokenRepository;
import cmc.nguyenvietgioi.luckcoffee.token.TokenType;
import cmc.nguyenvietgioi.luckcoffee.util.EmailUtil;
import cmc.nguyenvietgioi.luckcoffee.util.OtpUtil;
...
//        @Bean
//    public AuthenticationResponse testCreate() {
...
//        var user = userRepository.findByEmail("gioiace123@gmail.com").orElse(null);
