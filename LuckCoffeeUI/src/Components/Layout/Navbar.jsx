...
// css
import '../../style/navbar/headerHome.css'
            ...
            <AppBar position="fixed" className="navbar p-0">
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        {/* Toàn màn hình */}
                        <img src="/logo/LuckCoffee-logo1.png" alt="LuckCoffee" style={{ width: '100px', marginRight: '20px' }} />
                        <Typography
                            variant="h6"
                            noWrap
                            sx={{
                                ...
                                <>
                                    <>
                                        ...
                                        <Tooltip title={"Đơn hàng"}>
                                            <Link to={"/orders"}>
                                                <IconButton sx={{ p: 0, ml: 1 }}>
                                                    <AssignmentIcon style={{ color: "black", fontSize: "30px" }} />
                                                </IconButton>
                                            </Link>
                                        </Tooltip>
                                    </>
