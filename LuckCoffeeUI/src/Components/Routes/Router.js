  ...
  return (
    <Routes>
      ...
      <Route
        ...
        element={<TransactionDetailManagement />}
      ></Route>
      ...
      <Route path="/admin/product/create" element={<CreateProducts />}></Route>
      {/* Update Product: Cập nhật sản phẩm  */}
      <Route
        path="/management/update-product/:id"
